        ...
        columns: [
            { 'data': 'id', 'name': 'Id', 'className': 'd-none' },
            {
                ...
                'render': function (data, type, row) {
                    return `<div class="symbol symbol-50px h-90px overflow-hidden me-3">
                                        <a href="/Books/Details/${row.id}">
                                            <div class="symbol-label h-70px">
                                                <img src="${(row.thumbnailImageUrl === null ? '/Images/books/no-book.jpg' : row.thumbnailImageUrl)}" alt="${row.title}" class="w-100">
                                            </div>
                                            </a>
                                    </div>
